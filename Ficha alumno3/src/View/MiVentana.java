...
public class MiVentana extends JFrame {
	...
	//	pTurno.setBounds(150,100,100,150);
		...
		lstCiudades.add("Almeria");
		lstCiudades.add("Barcelona");
		lstCiudades.add("Jaen");
		
		
		lstCiudades.setBounds(140,100,80,100);
		...
		lstCiclos.setBounds(30,100,80,40);
		add(lstCiclos);
		...
		lstCiclos.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
		...
		btnVentana.setBounds(20, 200, 80, 40);
		add(btnVentana);
