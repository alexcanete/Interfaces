...
public class FrmBorrar extends JDialog {
	...
	public FrmBorrar() {
		...
		{
			JLabel lblSalirPregunta = new JLabel("\u00BFSeguro que desea borrar este PC?");
			lblSalirPregunta.setHorizontalAlignment(SwingConstants.CENTER);
			lblSalirPregunta.setBounds(0, 25, 317, 34);
