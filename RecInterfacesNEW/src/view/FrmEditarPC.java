...
public class FrmEditarPC extends JFrame {
	...
	public <MouseEvent> FrmEditarPC() {
		...
		lblMarcaSeleccionada = new JLabel("HP");
		...
		lblMarcaSeleccionada.setText(view.FrmPrincipal.table.getValueAt(view.FrmPrincipal.table.getSelectedRow(), 0).toString());
		txtModelo.setText(view.FrmPrincipal.table.getValueAt(view.FrmPrincipal.table.getSelectedRow(), 1).toString());
		comboboxListProveedor.setToolTipText(view.FrmPrincipal.table.getValueAt(view.FrmPrincipal.table.getSelectedRow(), 2).toString());
		comboboxListMicro.setToolTipText(view.FrmPrincipal.table.getValueAt(view.FrmPrincipal.table.getSelectedRow(), 3).toString());
		comboboxListRam.setToolTipText(view.FrmPrincipal.table.getValueAt(view.FrmPrincipal.table.getSelectedRow(), 4).toString());
		txtPrecio.setText(view.FrmPrincipal.table.getValueAt(view.FrmPrincipal.table.getSelectedRow(), 5).toString());
		


		btnGuardar.addActionListener(e -> {
			System.out.println(lblMarcaSeleccionada.getText());
			if((lblMarcaSeleccionada.getText() + "").length() <= 0) {
